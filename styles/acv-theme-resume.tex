...
\renewcommand*{\headeracademicstyle}[1]{{\fontsize{12pt}{1em}\headerfont\upshape\color{text}{#1}}}
...
\renewcommand{\acvHeaderAfterAddressSkip}{1.5mm}
\renewcommand{\acvHeaderAfterAcademicSkip}{-2mm}
